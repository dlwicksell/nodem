...
if (dist === undefined) {
    console.error(__filename + ': Error: Need to set $ydb_dist (YottaDB) or $gtm_dist (GT.M) before compiling v4wNode.m\n');
    process.exit(1);
}
...
if (routines === undefined) {
    console.error(__filename + ': Error: Need to set $ydb_routines (YottaDB) or $gtmroutines (GT.M) to include v4wNode.m\n');
